...
### using arms() univariate version in each step
...
mylike <- function(delta, mu1, mu2, sigma1, sigma2, x){
  log(delta / sigma1 * exp(-(x - mu1) ^ 2 / (2 * sigma1 ^ 2)) + (1 - delta) / sigma2 * exp(-(x - mu2) ^ 2 / (2 * sigma2))) - mu1 ^ 2 / 200 - mu2 ^ 2 / 200 - 3 * log(sigma1) -3 * log(sigma2) - 1 / (10 * sigma1 ^ 2) - 1 / (10 * sigma2 ^ 2)
}
...
### using arms() multivariate version
